            ...
            if (parent == grandparent->left){
                ...
                if (getColor(uncle) == RED){
                    ...
                    if (grandparent->parent == nullptr){
                        ...
                        singleCR(grandparent->parent->left);
                    }
                    else{
                        singleCR(grandparent->parent->right);
                    }
                    curr_node = parent;
                }
            }
                ...
                if (getColor(uncle) == RED){
                    ...
                    if (grandparent->parent == nullptr){
                        ...
                        singleCCR(grandparent->parent->left);
                    }
                    else{
                        singleCCR(grandparent->parent->right);
                    }
                    curr_node = parent;
                }
            }
